        ...
        axios.post(href, {
            "json":{
                "individuals":[
                    ...
                    "prVisBum": "1",
                    "assigment":true,
                    "href": "send/stepThree/registerIP"
            },
            "order_type_id": 2,
            href: ""
        })
                    ...
                    <div className="step-content">
                        ...
                        <div className="content">
                            ...
                            <div className="high">
                                ...
                                <input onChange={event => this.onChange(event)} type="text" className="date" onFocus={event => {$.noConflict(); $(".date").datepicker()}} id="birthDate" value={this.state.birthDate} name="birthDate" placeholder="01.01.1979" />
                            </div>
                            <div className="big">
